...
def main():
    ...
    Present_Price = st.number_input("Present_Price(in lacks)")
    ...
    ### the dictionary for all those values which we have to pass to API
    ...
    # call the API with request module with post method
    price=0
